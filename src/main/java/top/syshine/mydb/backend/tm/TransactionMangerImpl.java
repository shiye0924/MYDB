...
/**
 * @Author: 石烨
 * @Date: 2023/02/11/11:14
 * @Description:TM通过维护XID文件来维护事务的状态，并提供接口供其它模块来查询某个事务的状态
 */
public class TransactionMangerImpl implements TransactionManger{
    ...
    TransactionMangerImpl(RandomAccessFile raf, FileChannel fc) {
        this.file = raf;
        this.fc = fc;
    ...
    private void checkXIDCounter(){
        ...
        this.xidCounter = Parser.parseShort(buf.array());
