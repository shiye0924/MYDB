package top.syshine.mydb.backend.im;
...
public class BPlusTree {
    ...
    public static long create(DataManager dm) throws Exception {
        ...
        long rootUid = dm.insert(TransactionMangerImpl.SUPER_XID, rawRoot);
        return dm.insert(TransactionMangerImpl.SUPER_XID, Parser.long2Byte(rootUid));
    }
    ...
    private void updateRootUid(long left, long right, long rightKey) throws Exception {
        ...
        try {
            ...
            long newRootUid = dm.insert(TransactionMangerImpl.SUPER_XID, rootRaw);
            bootDataItem.before();
            SubArray diRaw = bootDataItem.data();
            System.arraycopy(Parser.long2Byte(newRootUid), 0, diRaw.raw, diRaw.start, 8);
            bootDataItem.after(TransactionMangerImpl.SUPER_XID);
        } finally {
            bootLock.unlock();
        }
    }
