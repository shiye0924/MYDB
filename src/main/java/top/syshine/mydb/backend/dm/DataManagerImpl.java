...
import top.syshine.mydb.backend.dm.dataItem.DataItemImpl;
...
import top.syshine.mydb.backend.dm.pageIndex.PageIndex;
import top.syshine.mydb.backend.dm.pageIndex.PageInfo;
...
public class DataManagerImpl extends AbstractCache<DataItem> implements DataManager {
    ...
    public DataManagerImpl(PageCache pc, Logger logger, TransactionManger tm) {
        super(0);
        this.pc = pc;
        this.logger = logger;
        this.tm = tm;
    ...
    // 为xid生成update日志
    public void logDataItem(long xid, DataItem di) throws IOException {
